...
// Build-time stand-in for the game's \a3\editor_f\Data\Scripts\dikCodes.h so
// HEMTT can resolve the #include during static analysis. At runtime the
// engine resolves the real file from the game data; this copy is never
// shipped in a PBO. Values are the standard DirectInput DIK_* constants.
...
#define DIK_ALT DIK_LMENU
#define DIK_RALT DIK_RMENU
#define DIK_CTRL DIK_LCONTROL
#define DIK_RCTRL DIK_RCONTROL
#define DIK_SHIFT DIK_LSHIFT

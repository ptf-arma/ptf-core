...
class cfgWeapons
{
	...
	class PTF_Helmet_Gute_Infantry_Mich2000_WD: rhsusf_ach_helmet_headset_ucp_alt
	{
		...
		author = "Paramarine Task Force";
		hiddenSelections[] = {"Camo1","Camo2"};
		hiddenSelectionsTextures[] = {"PTF_Helmets\data\ptf_mich_covered_rhino_wd_co_gute.paa.paa","rhsusf\addons\rhsusf_infantry\gear\head\data\ach_acc_tan_co.paa"};
		ace_hearing_protection = 0.8;
		ace_hearing_lowerVolume = 0;
		class ItemInfo: ItemInfo
		{
